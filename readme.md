...
### Extension & Backend Screenshots

**Chrome extension popup (overall UI)**
![Chrome extension popup](diagrams/chromeextension.png)

**Live translation running state in Chrome**
![Chrome live working](diagrams/chromeliveworking.png)

**Chrome extension to backend server flow**
![Chrome server flow](diagrams/chromeserver.png)

**Backend + Chrome working snapshot**
![Backend chrome working](diagrams/backendchromeworking.png)

**Hindi subtitle/text output sample**
![Hindi text sample](diagrams/hinditext.png)

**Oriya translation output sample**
![Oriya translation sample](diagrams/oriyatranslation.png)
...
### Generate TTS from CLI

```bash
python transcribe_pipeline.py --file sample_video.mp4 --tts --tts-model xtts --tts-play
```
